...
for l =  [1, 2, 3, 4, 5, 6, 9, 10, 12, 15, 18, 20, 30, 36, 45, 60, 90, 180]
    ...
    title(['Reconstructed Image for ', num2str(l), ' angle step size']);
    colorbar; % Add a colorbar for intensity scale
    drawnow;
    %saveas(gcf, ['Reconstructedimage' , num2str(t) ,'StepSize.png']);
end
